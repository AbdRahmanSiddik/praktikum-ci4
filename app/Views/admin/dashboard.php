        ...
        <div class="card-body">
          <div class="d-flex">
            <div class="flex-grow-1">
              ...
              <p>Welcome to the Admin clan! We appreciate your interest in our dashboard.</p><a class="btn"
                href="list-products.html">Go Premium</a>
            </div>
            <div class="flex-shrink-0"> <img src="<?= base_url('') ?>assets/images/dashboard/welcome.png"
                alt="">
            </div>
            <div>
              <div class="clockbox">
          ...
          <div class="header-top">
            ...
            <div class="dropdown icon-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="#">Weekly</a><a
                  class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a>
              </div>
            </div>
          </div>
        </div>
        <div class="card-body p-0">
          ...
          <div class="d-flex p-3 pt-0">
            <h2 class="me-2">$ 12,463</h2><span class="bg-light-danger">
              <svg>
                <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#down-arrow"> </use>
              </svg></span>
        ...
        <div class="card-body p-0">
          ...
          <div class="d-flex p-3 pt-0">
            <h2 class="me-2">$ 14,852</h2><span class="bg-light-success">
              <svg>
                <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#up-arrow"> </use>
              </svg></span>
            ...
            <table class="table display" style="width:100%">
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-primary"><img
                          src="<?= base_url('') ?>assets/images/dashboard/product/1.png" alt=""></span>
                  ...
                  <td> <img src="<?= base_url('') ?>assets/images/dashboard/flag/1.png" alt=""></td>
                  <td> <span>-51%</span>
                    <h5>$99.00</h5>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-primary"><img
                          src="<?= base_url('') ?>assets/images/dashboard/product/2.png" alt=""></span>
                  ...
                  <td> <img src="<?= base_url('') ?>assets/images/dashboard/flag/2.png" alt=""></td>
                  <td> <span>-78%</span>
                    <h5>$66.00</h5>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-primary"><img
                          src="<?= base_url('') ?>assets/images/dashboard/product/3.png" alt=""></span>
                      <div class="flex-grow-1 ms-2"><a href="list-products.html"><span>Nike Travel
                            Bag</span>
                          <h5>#UB654GH</h5>
                        </a></div>
                    </div>
                  ...
                  <td> <img src="<?= base_url('') ?>assets/images/dashboard/flag/3.png" alt=""></td>
                  <td> <span>-04%</span>
                    <h5>$116.00</h5>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-primary"><img
                          src="<?= base_url('') ?>assets/images/dashboard/product/4.png" alt=""></span>
                  ...
                  <td> <img src="<?= base_url('') ?>assets/images/dashboard/flag/4.png" alt=""></td>
                  <td> <span>-60%</span>
                    <h5>$99.00</h5>
                  </td>
                </tr>
            ...
            <table class="table display" id="recent-order" style="width:100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <div class="flex-shrink-0"><img src="<?= base_url('') ?>assets/images/dashboard/user/1.png"
                          alt=""></div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <div class="flex-shrink-0"><img src="<?= base_url('') ?>assets/images/dashboard/user/2.png"
                          alt=""></div>
                      <div class="flex-grow-1 ms-3"><a href="user-profile.html">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <div class="flex-shrink-0"><img src="<?= base_url('') ?>assets/images/dashboard/user/3.png"
                          alt=""></div>
                      <div class="flex-grow-1 ms-3"><a href="user-profile.html">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <div class="flex-shrink-0"><img src="<?= base_url('') ?>assets/images/dashboard/user/4.png"
                          alt=""></div>
                      <div class="flex-grow-1 ms-3"><a href="user-profile.html">
                ...
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-primary history">
                        <svg>
                          <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#send"></use>
                        </svg></span>
                      <div class="flex-grow-1 ms-2"><a href="list-products.html"><span>Receipt from external
                            Wallet</span>
                ...
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-secondary history">
                        <svg>
                          <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#work"></use>
                        </svg></span>
                      <div class="flex-grow-1 ms-2"><a href="list-products.html"><span>Process refund
                            to</span>
                ...
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-success history">
                        <svg>
                          <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#graph"></use>
                        </svg></span>
                      <div class="flex-grow-1 ms-2"><a href="list-products.html"><span>Sending to
                            Citizen</span>
                ...
                <tr>
                  <td>
                    <div class="d-flex"><span class="bg-light-danger history">
                        <svg>
                          <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#payment-bookmark"></use>
                        </svg></span>
                      <div class="flex-grow-1 ms-2"><a href="list-products.html"><span>Payment From
                            #12345</span>
        ...
        <div class="card-body">
          <div class="d-flex header-tab">
            <ul class="nav nav-tabs border-tab mb-0" id="bottom-tab" role="tablist">
              <li class="nav-item"><a class="nav-link nav-border tab-primary active pt-0" id="bottom-home-tab"
                  data-bs-toggle="tab" href="#bottom-home" role="tab" aria-controls="bottom-home"
                  aria-selected="true">All<span class="ms-2 bg-primary">3</span></a></li>
              <li class="nav-item"><a class="nav-link nav-border tab-primary" id="bottom-inbox-tab"
                  ...
                  aria-selected="false">Following</a></li>
              <li class="nav-item"><a class="nav-link nav-border tab-primary" id="bottom-contact-tab"
                  ...
                  aria-selected="false">Archive</a></li>
            </ul>
          ...
          <div class="tab-content content-tab" id="bottom-tabContent">
            <div class="tab-pane fade show active" id="bottom-home" role="tabpanel"
              ...
              <div class="d-flex align-items-center"><img src="<?= base_url('') ?>assets/images/dashboard/user/5.png"
                  alt="">
                <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                    <h5>
                      Ralph Edwards <strong> wants to edit </strong> tetrisly design system</h5><span>2hrs
                      Ago</span>
                  </a>
              ...
              <div class="d-flex align-items-center"><img src="<?= base_url('') ?>assets/images/dashboard/user/6.png"
                  alt="">
                <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                    <h5>
                      Jenny Wilson <strong> Completed </strong> Create new component</h5><span>2.15pm</span>
                  </a></div>
                <div class="flex-shrink-0">
              ...
              <div class="d-flex align-items-center figma-line"><img
                  src="<?= base_url('') ?>assets/images/dashboard/user/7.png" alt="">
                <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                    <h5>Jenny Wilson mentioned you in rewrite button component</h5><span>3.10pm</span>
                  </a></div>
              </div>
              <div class="figma-icon">
                <svg class="me-2">
                  <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#file"></use>
                </svg>
                <div class="flex-shrink-0">
          ...
          <div class="tab-content content-tab" id="bottom-tabContent2">
            <div class="tab-pane fade show" id="bottom-contact" role="tabpanel"
              ...
              <div class="d-flex align-items-center"><img src="<?= base_url('') ?>assets/images/dashboard/user/7.png"
                  alt="">
                <div class="flex-grow-1 ms-2"><a href="user-profile.html">
              ...
              <div class="d-flex align-items-center figma-line"><img
                  src="<?= base_url('') ?>assets/images/dashboard/user/2.png" alt="">
                <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                    <h5>
