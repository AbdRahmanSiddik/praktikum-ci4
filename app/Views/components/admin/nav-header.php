  ...
  <div class="header-wrapper row m-0">
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper">
        <a href="index.html">
          <img class="img-fluid for-light" src="<?= base_url('') ?>assets/images/logo/logo-1.png" alt="">
              ...
              <div class="Typeahead Typeahead--twitterUsers">
                <div class="u-posRelative d-flex">
                  ...
                  <input class="demo-input py-0 Typeahead-input form-control-plaintext w-100" type="text"
                    placeholder="Search anything..." name="q" title="">
                </div>
              </div>
            </div>
          </li>
      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          <div class="notification-box">
            <svg>
              <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#fill-Bell"></use>
          ...
          <div class="onhover-show-div notification-dropdown">
            ...
            <div class="d-flex align-items-center"><img src="<?= base_url('') ?>assets/images/dashboard/user/5.png"
              ...
              <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                  <h5>
                    Ralph Edwards <strong> wants to edit </strong> tetrisly design system</h5><span>2hrs Ago</span>
                </a></div>
        ...
        <li class="onhover-dropdown">
          <svg>
            <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#fill-star"></use>
          </svg>
        ...
        <li>
          <div class="mode">
            <svg>
              <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#fill-dark"></use>
            </svg>
          </div>
        </li>
        <li class="onhover-dropdown">
          <div class="message">
            <svg>
              <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#fill-message"></use>
            ...
            <ul>
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="<?= base_url('') ?>assets/images/user/3.jpg"
                      alt=""></div>
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="<?= base_url('') ?>assets/images/user/6.jpg"
                      alt=""></div>
                  <div class="flex-grow-1">
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="<?= base_url('') ?>assets/images/user/10.jpg"
                      alt=""></div>
                  <div class="flex-grow-1">
        ...
        <li class="cart-nav onhover-dropdown">
          <div class="cart-box">
            <svg>
              <use href="<?= base_url('') ?>assets/svg/icon-sprite.svg#fill-Buy"></use>
            </svg>
          </div>
            ...
            <ul>
              <li>
                <div class="d-flex"><img class="img-fluid b-r-5 img-60"
                    src="<?= base_url('') ?>assets/images/ecommerce/06.jpg" alt="">
              ...
              <li>
                <div class="d-flex"><img class="img-fluid b-r-5 img-60"
                    src="<?= base_url('') ?>assets/images/ecommerce/02.jpg" alt="">
